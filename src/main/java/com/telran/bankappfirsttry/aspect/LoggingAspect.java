package com.telran.bankappfirsttry.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution (public * com.telran.bankappfirsttry.controller.*.*(..))")
    public void controllerLog(){

    }

    @Pointcut("execution (public * com.telran.bankappfirsttry.service.*.*(..))")
